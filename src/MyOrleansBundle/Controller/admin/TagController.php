...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('MyOrleansBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('MyOrleansBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('MyOrleansBundle\Form\TagType', $tag);
