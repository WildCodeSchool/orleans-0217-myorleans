...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('MyOrleansBundle:User')->findAll();
    ...
    {
        $user = new User();
        $form = $this->createForm('MyOrleansBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('MyOrleansBundle\Form\UserType', $user);
